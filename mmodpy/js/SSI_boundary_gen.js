...
//
// This script generates boundary conditions for driving 3D SSI
// models with a compliant velocity field. The lateral boundaries
// are comprised of massive SRA columns tied into the main model 
// with NRBs. The bottom boundary consists of properly scaled 
// lysmer dampers combined with LOAD_NODE_POINT cards scaled in a
// similar fashion. The approach for the lateral boundaries is 
// necesary if the horizontal forces on each side are not 
...
// Specific to lysmer dampers and load cards for elements in the existing model
...
for (var i=0;i<allSolids.length;i++){
